...
Class Customer_model extends CI_Model
{
	...
	********************************************************************/
	...
	function save_address($data)
	{
		...
		if(!empty($data['id']))
		{
			...
			$this->db->where('id', $data['id']);
			$this->db->update('gc_en_customers_address_bank', $data);
			...
			$this->db->set_dbprefix('');
			$this->db->insert('gc_en_customers_address_bank', $data);
			$this->db->set_dbprefix('gc_fr_');
	...
	function delete_address($id, $customer_id)
	{
		...
		$this->db->set_dbprefix('');
		$this->db->where(array('id'=>$id, 'customer_id'=>$customer_id))->delete('gc_en_customers_address_bank');
		$this->db->set_dbprefix('gc_fr_');
	...
	function save($customer)
	{
		if ($customer['id'])
		{
			...
			$this->db->set_dbprefix('');
			$this->db->where('id', $customer['id']);
			$this->db->update('gc_en_customers', $customer);
			$this->db->set_dbprefix('gc_fr_');
		...
		else
		{
			...
			$this->db->set_dbprefix('');
			$this->db->where('id', $customer['id']);
			$this->db->insert('gc_en_customers', $customer);
			$this->db->set_dbprefix('gc_fr_');
	...
	function delete($id)
	{
		...
		*/
		...
		$this->db->set_dbprefix('');
		$this->db->where('id', $id);
		$this->db->delete('gc_en_customers');
		$this->db->set_dbprefix('gc_fr_');
		...
		$this->db->set_dbprefix('');
		$this->db->where('customer_id', $id);
		$this->db->delete('gc_en_customers_address_bank');
		$this->db->set_dbprefix('gc_fr_');
		...
		{
			$this->db->where('order_id', $order->id);
			$this->db->delete('gc_en_order_items');
		}
		$this->db->set_dbprefix('gc_fr_');
	...
	*/
	...
	function delete_group($id)
	{
		...
		$this->db->set_dbprefix('');
		$this->db->where('id', $id);
		$this->db->delete('gc_en_customer_groups');
		$this->db->set_dbprefix('gc_fr_');
	}
	...
	function save_group($data)
	{
		if(!empty($data['id'])) 
		{
			...
			$this->db->set_dbprefix('');
			$this->db->where('id', $data['id'])->update('gc_en_customer_groups', $data);
			$this->db->set_dbprefix('gc_fr_');
			...
			$this->db->set_dbprefix('');
			$this->db->insert('gc_en_customer_groups', $data);
			$this->db->set_dbprefix('gc_fr_');
