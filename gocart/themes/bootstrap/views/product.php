					...
					<div class="product-cart-form">
						...
						<div class="control-group">
							<?php if($product->status_reserver == '1') : ?>
								<div class="controls">
									<h6 style="vertical-align: center; text-align: middle; padding-top: 10px;">SORRY ! THIS ARTICLE IS ALREADY RESERVED</h6> 
								</div>
							<?php elseif ($product->status_vendu == '1'): ?>
								<div class="controls">
									<h6 style="vertical-align: center; text-align: middle; padding-top: 10px;">SORRY ! THIS ARTICLE IS ALREADY BOUGHT</h6> 
								</div>
			...
			<div class="row">
				...
				<div class="span7 pull-left">
					<span class="pull-left" style="display: inline; padding-right: 40px; overflow:hidden; height: 100%; width: 100%; vertical-align: baseline;">
						<div class="fb-like" href='<?php echo base_url('/article-' . $product->article_ID . '/shopping-cart/en/html') ; ?>' data-send="true" data-layout="standard" data-width="450" data-show-faces="true" data-font="lucida grande" ref="<?php echo ('article-' . $product->article_ID) ; ?>"></div>
					</span>
					<span class="pull-left" style="display: inline; padding-right: 40px; overflow:hidden; height: 100%; width: 81px; vertical-align: top;">
						<div class="bubble_twitter">
							<a href="https://twitter.com/share" class="twitter-share-button" data-url="<?php echo base_url('/article-' . $product->article_ID . '/shopping-cart/en/html'); ?> "data-text="I just checked out <?php echo 'Article-' . $product->article_ID;?> at Mom To Mom" data-via="mom2mom_news" data-lang="en" data-hashtags="<?php foreach ($prod_categories->marque as $marque) { echo $marque . ','; } ; ?>mom2mom,momtomom,fashion,retrokidsclothes,children,kids,kidsfashion,kidsclothes,mom,moms,mothers,paris,style,newseason" data-counturl="http://mom2mom.fr/en/html">Tweet</a>
						</div>
					</span>
