...
<div id="banners">
	...
	foreach ($banners as $banner)
	{
		...
		echo '<img class="banners_img'.$banner_count.'" src="'.base_url($this->config->item('img_upload_folder').'uploads/'.$banner->image).'" />';
...
<div id="homepage_boxes">
	...
	foreach ($boxes as $box)
	{
		...
		echo '<img src="'.base_url($this->config->item('img_upload_folder').'uploads/'.$box->image).'" />';
